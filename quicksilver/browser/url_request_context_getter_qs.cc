...
URLRequestContextGetterQS::URLRequestContextGetterQS(
...
net::NetworkDelegate* URLRequestContextGetterQS::CreateNetworkDelegate() {
  return new NetworkDelegateQS;
}

net::ProxyConfigService* URLRequestContextGetterQS::GetProxyConfigService() {
  return net::ProxyService::CreateSystemProxyConfigService(
      io_loop_->message_loop_proxy(), file_loop_->message_loop_proxy());
}

net::ProxyService* URLRequestContextGetterQS::GetProxyService() {
...
net::URLRequestContext* URLRequestContextGetterQS::GetURLRequestContext() {
  ...
  if (!url_request_context_) {
    ...
    storage_->set_http_user_agent_settings(
        new net::StaticHttpUserAgentSettings(
            "en-us,en", content::GetContentClient()->GetUserAgent()));
...
scoped_refptr<base::SingleThreadTaskRunner>
    URLRequestContextGetterQS::GetNetworkTaskRunner() const {
  return BrowserThread::GetMessageLoopProxyForThread(BrowserThread::IO);
}

net::HostResolver* URLRequestContextGetterQS::host_resolver() {
